...
![Advisor dashboard](dashboard.png)
...
- `login.png`, `dashboard.png`, `case_detail.png`, `crm_export.png` - product interface screenshots
- `architecture_diagram.png` - high-level Azure solution architecture
